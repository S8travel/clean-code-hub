  ...
  return (
    <div className="p-6 space-y-4">
      ...
      <div className="grid grid-cols-3 gap-4">
        {[
          { label: t("Tổng ĐNTT"), value: metrics.total, cls: "text-foreground",
            sub: `${fmt(metrics.tongTien)} đ` },
          { label: t("Chờ duyệt"), value: metrics.choDuyet, cls: "text-yellow-600",
            sub: `${t("7 ngày tới")}: ${fmt(metrics.choDuyet7dTien)} đ` },
          { label: t("Đã duyệt"), value: metrics.daDuyet, cls: "text-blue-600",
            sub: `${t("7 ngày qua")}: ${fmt(metrics.daDuyet7dTien)} đ` },
        ].map(m => (
          <Card key={m.label}>
