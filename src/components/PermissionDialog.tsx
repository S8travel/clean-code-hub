      ...
      <DialogContent className="sm:max-w-md p-0 gap-0" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="px-5 py-4 space-y-2 max-h-[280px] overflow-y-auto">
          {isLoading ? (
            ...
            <p className="text-xs text-muted-foreground py-4 text-center">Chưa có ai được phân quyền.</p>
          ) : (
            permissions?.map((p) => {
        ...
        <div className="px-5 py-4 border-t border-border/40 space-y-3">
          <p className="text-xs font-medium text-muted-foreground uppercase">Thêm người</p>
          <div className="flex items-end gap-2">
            <div className="flex-1 space-y-1">
              <SearchableSelect
                ...
                emptyText="Không còn người khả dụng"
              />
            </div>
