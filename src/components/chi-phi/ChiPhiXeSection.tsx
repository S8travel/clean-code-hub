    ...
    <div className="rounded-lg border border-border bg-card overflow-hidden">
                    ...
                    <tr className="bg-amber-50/60 border-b border-dashed border-amber-200">
                      <td colSpan={8} className="px-4 py-2">
                        <div className="flex items-center gap-2 flex-wrap">
                          ...
                          <Input
                            autoFocus
                            placeholder="Mô tả (vd: Xe trung chuyển)"
      ...
      <Dialog open={!!modal} onOpenChange={(v) => { if (!v) setModal(null); }}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle className="text-sm">Tạo đề nghị thanh toán — {modal?.moTa || "Xe"}</DialogTitle>
          </DialogHeader>
          <div className="space-y-3 py-2 text-xs">
            ...
            <RadioGroup value={modalMode} onValueChange={(v) => setModalMode(v as "full" | "deposit")} className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <Label htmlFor="xe-dep" className="text-xs cursor-pointer">1 phần (cọc)</Label>
              </div>
            </RadioGroup>
            {modalMode === "deposit" && (
          ...
          <div className="space-y-3">
            ...
            <RadioGroup value={resendMode} onValueChange={(v) => setResendMode(v as any)} className="flex gap-4">
              <div className="flex items-center gap-1.5">
                <RadioGroupItem value="full" id="xe-resend-full" />
                <Label htmlFor="xe-resend-full" className="text-xs">Toàn bộ</Label>
              </div>
              <div className="flex items-center gap-1.5">
                <RadioGroupItem value="partial" id="xe-resend-partial" />
                <Label htmlFor="xe-resend-partial" className="text-xs">1 phần</Label>
              </div>
            </RadioGroup>
            {resendMode === "partial" && (
            ...
            <div className="space-y-2">
              ...
              <RadioGroup value={cancelMode} onValueChange={(v) => setCancelMode(v as any)} className="flex gap-4">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <Label htmlFor="xe-cancel-cn" className="text-xs">Ghi công nợ</Label>
                </div>
              </RadioGroup>
            </div>
          )}
