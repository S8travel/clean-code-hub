          ...
          <div className="space-y-3 py-1 text-sm">
            ...
            {(() => {
              ...
              return (
                <div className="space-y-1.5">
                  <p className="text-xs text-purple-700 font-medium">{t("Thừa")} {fmt(Math.abs(delta))} ₫ — {t("chọn hình thức xử lý")}:</p>
            ...
            <div className="space-y-1">
              ...
              <Textarea
                ...
                placeholder={t("VD: Đổi loại phòng, giảm số đêm...")}
              />
            </div>
          </div>
        )}
