-- Track ai hủy ĐNTT / khi nào — UI hiển thị "Đã hủy + Tên + thời gian" thay
-- vì "—" trong cell duyệt sau khi hủy.

ALTER TABLE de_nghi_thanh_toan
  ADD COLUMN IF NOT EXISTS huy_boi uuid REFERENCES auth.users(id) ON DELETE SET NULL,
